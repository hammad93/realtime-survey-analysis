...
$query = mysqli_query($link,"SELECT * FROM SURVEY_2_RESULTS WHERE question_id=2 LIMIT 10");
...
$query2 = mysqli_query($link,"SELECT COUNT(*) AS c FROM `SURVEY_2_RESULTS` WHERE question_id=0 ");
$resultTotal = mysqli_fetch_assoc($query2);
$response[0]['total'] = $resultTotal['c'];

$query = mysqli_query($link,"SELECT COUNT(*) AS c FROM `SURVEY_2_RESULTS` WHERE question_id=0 AND answer=1 "); 
$result1 = mysqli_fetch_assoc($query);
$response[0]['result1'] = $result1['c'];

$query = mysqli_query($link,"SELECT COUNT(*) AS c FROM `SURVEY_2_RESULTS` WHERE question_id=0 AND answer=2 "); 
$result1 = mysqli_fetch_assoc($query);
$response[0]['result2'] = $result1['c'];

$query = mysqli_query($link,"SELECT COUNT(*) AS c FROM `SURVEY_2_RESULTS` WHERE question_id=0 AND answer=3 "); 
$result1 = mysqli_fetch_assoc($query);
$response[0]['result3'] = $result1['c'];

$query = mysqli_query($link,"SELECT COUNT(*) AS c FROM `SURVEY_2_RESULTS` WHERE question_id=0 AND answer=4 "); 
$result1 = mysqli_fetch_assoc($query);
...
$query2 = mysqli_query($link,"SELECT COUNT(*) AS c FROM `SURVEY_2_RESULTS` WHERE question_id=3 ");
$resultTotal = mysqli_fetch_assoc($query2);
$response[3]['total'] = $resultTotal['c'];
$query = mysqli_query($link,"SELECT COUNT(*) AS c FROM `SURVEY_2_RESULTS` WHERE question_id=3 AND answer=1 "); 
$result1 = mysqli_fetch_assoc($query);
$response[3]['result1'] = $result1['c'];
$query = mysqli_query($link,"SELECT COUNT(*) AS c FROM `SURVEY_2_RESULTS` WHERE question_id=3 AND answer=2 "); 
$result1 = mysqli_fetch_assoc($query);
$response[3]['result2'] = $result1['c'];
$query = mysqli_query($link,"SELECT COUNT(*) AS c FROM `SURVEY_2_RESULTS` WHERE question_id=3 AND answer=3 "); 
$result1 = mysqli_fetch_assoc($query);
$response[3]['result3'] = $result1['c'];
$query = mysqli_query($link,"SELECT COUNT(*) AS c FROM `SURVEY_2_RESULTS` WHERE question_id=3 AND answer=4 "); 
$result1 = mysqli_fetch_assoc($query);
